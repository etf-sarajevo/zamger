...
CREATE TABLE IF NOT EXISTS `zadatak` (
  ...
  `bodova` float NOT NULL DEFAULT '0',
  `izvjestaj_skripte` text COLLATE utf8_slovenian_ci DEFAULT NULL,
  `vrijeme` datetime DEFAULT NULL,
  `komentar` text COLLATE utf8_slovenian_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `zavrsni` (
  ...
  `sazetak` text collate utf8_slovenian_ci DEFAULT NULL,
  `summary` text collate utf8_slovenian_ci DEFAULT NULL,
  `mentor` int(11) NOT NULL,
  `drugi_mentor` int(11) default NULL,
  `student` int(11) default NULL,
  `kandidat_potvrdjen` tinyint(4) NOT NULL,
  `biljeska` text collate utf8_slovenian_ci DEFAULT NULL,
  ...
  `odluka_komisija` int(11) DEFAULT NULL,
  `odluka_tema` int(11) DEFAULT NULL,
  PRIMARY KEY  (`id`),
  KEY `predmet` (`predmet`),
...
CREATE TABLE IF NOT EXISTS `kandidati` (
  ...
  `studijski_program2` INT NOT NULL,
  `studijski_program3` INT NOT NULL,
  `studijski_program4` INT NOT NULL,
  `studijski_program5` INT NOT NULL,
  `program_prioritet` INT NOT NULL,
