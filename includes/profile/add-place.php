...
function includes_profile_add_place($drzava, $opcina) {
	?>
	<!-- Insert new place -->
				...
				<div class="modal-body">
					<form>
						<div class="form-group">
							<label for="newPlace" class="col-form-label">Naziv mjesta :</label>
						...
						<div class="form-group">
							<div class="row">
								...
								<div class="col-md-6 newMunicSelW">
									<label for="newMunicSel" class="col-form-label">Općina:</label>
								...
								<div class="col-md-6 newMunicTextW d-none">
									<label for="newMunicText" class="col-form-label">Općina:</label>
									<?= Form::text('newMunicText', '', ['class' => 'form-control form-control-sm', 'id' => 'newMunicText', 'required' => 'required', 'style' => 'width:100%;', 'placeholder' => 'Unesite naziv općine']) ?>
								</div>
							</div>
						</div>
					</form>
