...
{	
	...
	$q100 = myquery("SELECT p.id, p.naziv, p.kratki_naziv FROM predmet p, nastavnik_predmet np WHERE np.nastavnik=$userid AND np.akademska_godina=$ag AND np.predmet=p.id");
