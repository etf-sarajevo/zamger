...
<link type="text/css" rel="stylesheet" href="/zamger.css" />
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr bgcolor="#BBBBFF">
		<!--td><table width="100%" border="0" cellspacing="0" cellpadding="0"><tr-->
			...
			<a href="../../vjezba/index.php"><img src="../../vjezba/images/etf-50x50.png" width="50" height="50" border="0"></a>
			</td><td width="50%" align="right">
			<font color="#FFFFFF" size="5">
			<b><a href="../../vjezba/index.php"><font color="#FFFFFF">ZAMGER 4.0 beta2</font></a>&nbsp;</b></font><br/>
			<font color="#FFFFFF" size="1">
			<a href="http://195.130.59.135/bugzilla" target="_new">
			<img src="../../vjezba/images/16x16/zad_bug.png" width="16" height="16" border="0" align="center">&nbsp;
