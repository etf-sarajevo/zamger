...
class ScoringElement {
	public $id;
	public $name, $guiName, $abbrev, $ScoringType, $max, $pass, $option, $mandatory, $points;
	...
	public function fromScoring($scoringId, $seType = 0) {
		$sql = "";
	...
	public function forStudent($studentId, $courseOfferingId) {
