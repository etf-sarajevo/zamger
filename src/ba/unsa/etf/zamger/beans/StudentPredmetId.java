...
/**
 * StudentPredmetId generated by hbm2java
 */
public class StudentPredmetId implements java.io.Serializable {

	private int student;
	private int predmet;

	public StudentPredmetId() {
	}

	public StudentPredmetId(int student, int predmet) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StudentPredmetId))
			return false;
		StudentPredmetId castOther = (StudentPredmetId) other;
