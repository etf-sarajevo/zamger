...
/**
 * ZadatakFajlovi generated by hbm2java
 */
public class ZadatakFajlovi implements java.io.Serializable {
	...
	public ZadatakFajlovi() {
	}

	public ZadatakFajlovi(int zadaca, int redniBroj, int student, byte status,
