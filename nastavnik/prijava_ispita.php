...
$q20 = myquery("SELECT UNIX_TIMESTAMP(i.datum), k.gui_naziv FROM ispit as i, komponenta as k WHERE i.id=$ispit and i.komponenta=k.id");
...
$tip_ispita = mysql_result($q20,0,1);
