...
function studentska_anketa(){
	...
	if ($_REQUEST['akcija']=="deaktivacija") {
		...
		$result401=myquery("update anketa_predmet set aktivna=0 where anketa=$id and predmet=0");
	...
	if ($_REQUEST['akcija']=="aktivacija") {
		...
		$result401 = myquery("update anketa_predmet set aktivna=1 where anketa=$id and predmet=0");
