...
$istanadjeno=0;
			...
			while ($r60 = mysql_fetch_row($q60)) {
				$predmet_tmp = $r60[0];
print "ptmp $predmet_tmp<br>";
if (in_array($predmet_tmp,$bilo))continue;
...
$predmet_stari[$predmet_tmp]=0;
$istanadjeno++;
print "pao $predmet_tmp<br>";
				} else {
$nadjeno++;
array_push($bilo, $predmet_tmp);
print "polozio $predmet_tmp<br>";
				}
			}

print "is $r30[1] nadjeno $nadjeno istanadjeno $istanadjeno<br>";
...
iz.predmet=p.id");
				...
				while ($r60 = mysql_fetch_row($q60)) {
if (in_array($r60[0], $bilo)) continue;
